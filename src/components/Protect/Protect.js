...
const Protect = () => {
  ...
  return (
    <div className="h-screen md:static absolute top-0 left-0 bottom-0 right-0 w-full flex items-center justify-center font-semibold text-yellow-500">
      <div className="bg-gray-500 shadow-2xl rounded-md md:w-[80%] w-full h-full md:h-[80%] text-[20px] md:text-3xl flex flex-col items-center justify-center">
        <p className="text-center">Upss, You dont have permission to access this page 😩</p>
        <p className="text-[18px] md:text-2xl">Back to previous page </p>{' '}
